            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li><Link to="/features" className="text-gray-500 hover:text-[#0066CC] transition-colors font-sans font-medium text-sm">Features</Link></li>
                            <li><Link to="/use-cases" className="text-gray-500 hover:text-[#0066CC] transition-colors font-sans font-medium text-sm">Use Cases</Link></li>
                            <li><Link to="/pricing" className="text-gray-500 hover:text-[#0066CC] transition-colors font-sans font-medium text-sm">Pricing</Link></li>
                        </ul>
                    </div>
                ...
                <div className="mt-16 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-400 text-sm font-sans">
                        © 2024 Capable. All rights reserved.
                    </p>
                    <div className="flex items-center gap-6">
                        <a href="#" className="text-gray-400 hover:text-[#0066CC] transition-colors">
