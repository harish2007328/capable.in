    ...
    <section className="w-full bg-[#f9f9f9] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-start pt-16 border-t border-gray-100/50">
                ...
                >
                    <motion.div variants={fadeUp} className="flex gap-1 mb-8">
                        {[1, 2, 3, 4, 5].map(star => (
                    ...
                    <motion.p variants={fadeUp} className="text-2xl md:text-3xl font-display text-gray-900 leading-[1.3] mb-12 max-w-lg">
                        "The platform's deep research and actionable steps are incredible. It aligns perfectly with our specific startup goals."
                    </motion.p>

                    <motion.div variants={fadeUp} className="mb-16 pl-6 border-l-2 border-blue-500">
                    ...
                    <motion.p variants={fadeUp} className="text-gray-700 text-lg md:text-xl font-display font-normal leading-relaxed italic pr-4 mb-12">
                    ...
                    <motion.div variants={fadeUp} className="w-full max-w-md aspect-[16/9] rounded-[14px] overflow-hidden bg-gray-100 relative shadow-soft group">
                        <img
                ...
                <motion.div 
                    ...
                    variants={staggerContainer}
                >
                    <motion.h3 variants={fadeUp} className="text-3xl md:text-5xl lg:text-7xl font-display font-normal text-gray-900 leading-tight mb-16 tracking-tightest mt-12 lg:mt-0">
                    ...
                    <div className="space-y-12">
                        {[
                            ...
                            <motion.div variants={fadeUp} key={idx} className="space-y-2 md:space-y-3">
